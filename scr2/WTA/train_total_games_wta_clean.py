...
"""
Обучение регрессионной модели total_games для WTA на чистом датасете
...
MODEL_DIR = 'WTA/TOTAL/model/total_games_wta'
...
print("\n=== ОСНОВНЫЕ МЕТРИКИ (WTA total_games) ===")

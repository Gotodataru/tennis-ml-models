...
"""
Обучение классификационной модели winner (победитель матча) для WTA на датасете winner_features.csv.
...
MODEL_DIR = 'WTA/WINNER/model/winner_wta'

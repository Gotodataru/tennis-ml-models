...
"""
Обучение классификационной модели first_set_winner для WTA на чистом датасете.
...
MODEL_DIR = 'WTA/FIRSTSET/model/first_set_wta'
...
print("\n=== ОСНОВНЫЕ МЕТРИКИ (WTA first_set_winner) ===")

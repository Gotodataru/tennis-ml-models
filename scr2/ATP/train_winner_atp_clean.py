...
"""
Обучение классификационной модели winner (победитель матча) для ATP на датасете winner_features.csv.
Целевая переменная: winner_1 – победил ли первый игрок.
"""
...
# ========== КОНФИГУРАЦИЯ ==========
DATA_PATH = 'data/winner_features.csv'
MODEL_DIR = 'ATP/WINNER/model/winner_atp'
FEATURE_LIST_PATH = 'data/feature_analysis/selected_features.txt'   # правильный путь
...
plt.xlabel('Предсказанная вероятность победы 1-го игрока')
plt.ylabel('Частота')
